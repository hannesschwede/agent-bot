    ...
    <div className="min-h-screen bg-white text-black font-sans">
      <nav className="sticky top-0 z-50 w-full border-b border-black/10 bg-white/90 backdrop-blur-md">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-4">
          ...
          <a href="/tools/code-reviewer/index.html" target="_blank" rel="noopener noreferrer" className="bg-[#FF4F15] text-white px-4 py-2 text-[11px] font-bold uppercase tracking-[0.15em] hover:bg-[#182332] transition-colors">Tool starten</a>
        </div>
      </nav>
      <header className="bg-[#182332] text-white">
        <div className="mx-auto max-w-6xl px-6 py-20 md:py-32">
          ...
          <a href="/tools/code-reviewer/index.html" target="_blank" rel="noopener noreferrer" className="inline-block mt-10 bg-[#FF4F15] text-white px-8 py-4 text-sm font-bold uppercase tracking-[0.15em] hover:bg-white hover:text-[#182332] transition-colors">Jetzt starten</a>
        </div>
      </header>
      ...
      <section className="px-6 py-20 md:py-28 bg-black/[0.02]">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="bg-[#1B2838] rounded-sm p-6 md:p-8 font-mono text-sm overflow-x-auto border-l-4 border-[#FF4F15]">
            ...
            <div className="text-[#D4D4D4]">git clone /tools/code-reviewer/index.html</div>
      ...
      <section className="px-6 py-20 md:py-28">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <a href="/tools/code-reviewer/index.html" target="_blank" rel="noopener noreferrer" className="inline-block bg-[#182332] text-white px-8 py-4 text-sm font-bold uppercase tracking-[0.15em] hover:bg-[#FF4F15] transition-colors">Tool starten</a>
        </div>
      </section>
